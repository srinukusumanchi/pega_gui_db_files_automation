...
#      | 4587_GIC_EMAIL |
  ...
  @EMAIL @Workstream-4
    ...
    @RESPCrossSell @5466
    @RRSPCrossSell @5465
    @SuppCardCrossSell_BVT_Vikas @5468
...
#    And enter customer id in ih by customer screen and get IH table data
  ...
  @EMAIL  @CreditorInsuranceInitial @2423 @CreditorInsurance_2423_IH_POSITIVE @VS17084
...
#    And enter customer id in ih by customer screen and get IH table data
    ...
    Examples:
      | Test cases                               |
      | 2423_Creditor Insurance_Email_2423012201 |
      | 2423_Creditor Insurance_Email_2423012202 |
      | 2423_Creditor Insurance_Email_2423012203 |
...
#    And enter customer id in ih by customer screen and get IH table data
  ...
  @ULOC_CLI @ULOC_CLI_EML_IH_Base_Validation_6090_Sanity @6090 @EML @RS23043
...
#    Then validate ULOC CLI offer details against IH
  ...
  @ULOC_CLI @ULOC_CLI_SOL_IH_Base_Validation_6090_Sanity @6090 @SOL @RS23043
