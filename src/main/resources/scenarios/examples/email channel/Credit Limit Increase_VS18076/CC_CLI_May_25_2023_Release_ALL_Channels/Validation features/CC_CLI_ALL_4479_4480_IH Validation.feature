@CLI_ALL_Channel_IHValidation
Feature: Validation for 4479 4480 Credit Card Credit Limit Increase in OB and IB Channels

    #Positive IH Validation - CIE4479
  @CC_CLI @CC_CLI_ALL_IH_Positive_Validation_4479 @4479 @ALL @VS18076 @CC_CLI_Positive_IHValidation
  Scenario Outline: CC_CLI VS18076_4479_ALL Validate IH details against database and pega for Positive test cases in ALL Channels
...
#    And Execute REST Call for "CSE" channel
    Then validate Credit Card CLI offer details against IH for "EML" Channel with "Outbound" Direction having "IPT" Outcome
    Then validate Credit Card CLI offer details against IH for "DML" Channel with "Outbound" Direction having "IPT" Outcome
    Then validate Credit Card CLI offer details against IH for "IVR" Channel with "Outbound" Direction having "IPT" Outcome
    Then validate Credit Card CLI offer details against IH for "SOL" Channel with "Outbound" Direction having "IPT" Outcome
    Then validate Credit Card CLI offer details against IH for "CSA" Channel with "Outbound" Direction having "IPT" Outcome
    Then validate Credit Card CLI offer details against IH for "FFT" Channel with "Outbound" Direction having "IPT" Outcome
    Then validate Credit Card CLI offer details against IH for "PAL" Channel with "Outbound" Direction having "IPT" Outcome
    Then validate Credit Card CLI offer details against IH for "ABM" Channel with "Outbound" Direction having "IPT" Outcome
    Then validate Credit Card CLI offer details against IH for "DIA" Channel with "Outbound" Direction having "IPT" Outcome
...
#     STUDENTS
  ...
  @CC_CLI @CC_CLI_ALL_IH_Negative_Validation_4479 @4479 @ALL @VS18076 @CC_CLI_Negative_IHValidation
  Scenario Outline: CC_CLI VS18076_4479_ALL Validate IH details against database and pega for Negative test cases in ALL Channels
    Given load data from "CC_CLI_ALL_Channels" excel sheet
    Given read batch file customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    When read account information details from excel sheet "ACCT_DIM" for "<Test cases>"

    Then verify using IH API that offer is not returned for "EML" channel
    Then verify using IH API that offer is not returned for "DML" channel
    Then verify using IH API that offer is not returned for "IVR" channel
    Then verify using IH API that offer is not returned for "SOL" channel
    ...
    Then verify using IH API that offer is not returned for "PAL" channel
    Then verify using IH API that offer is not returned for "ABM" channel
  ...
  @CC_CLI @CC_CLI_ALL_IH_Positive_Validation_4480 @4480 @ALL @VS18076 @CC_CLI_Positive_IHValidation
  Scenario Outline: CC_CLI VS18076_4480_ALL Validate IH details against database and pega for Positive test cases in ALL Channels
    Given load data from "CC_CLI_ALL_Channels" excel sheet
    Given read batch file customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    When read account information details from excel sheet "ACCT_DIM" for "<Test cases>"
...
#     STUDENTS
  ...
  @CC_CLI @CC_CLI_ALL_IH_Negative_Validation_4480 @4480 @ALL @VS18076 @CC_CLI_Negative_IHValidation
  Scenario Outline: CC_CLI VS18076_4480_ALL Validate IH details against database and pega for Negative test cases in ALL Channels
    Given load data from "CC_CLI_ALL_Channels" excel sheet
    Given read batch file customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    When read account information details from excel sheet "ACCT_DIM" for "<Test cases>"
