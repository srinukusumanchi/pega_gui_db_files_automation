@5504_Batch_Validation
Feature: Batch file validation for MPSA_Contribution RS21098
...
#  Example: “AcctNum:” + .ACCT_NUM + “|LastName:”+”.INDV_LAST_NM+”|AcctBal:”+.ACCT_BAL_AMT
  ...
  @MPSAContributionEmail @MPSAContributionEmail_DatFile_Positive_Generic_Validation @5504 @EMAIL @RS21098 @AUTOTESTTOTAL#30
  Scenario Outline: MPSA ContributionEmail_RS21098_5468_EMAIL Validate batch file details against database and pega for Positive test cases
  ...
  @MPSAContributionEmail @MPSAContributionEmail_DatFile_Positive_CellGroup_Validation @5504 @EMAIL @RS21098 @AUTOTESTTOTAL#15
  Scenario Outline: MPSA ContributionEmail_RS21098_5468_EMAIL Validate batch file details against database and pega for Positive test cases for Cell Group
    Given load data from "MPSAContributionFunds" excel sheet
    Given read batch file customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    When read account information details from excel sheet "ACCT_DIM" for "<Test cases>"
    And read MPSA Contribution Funds "MPSAContributionFunds" extract file customer offer details
  ...
  @MPSAContributionEmail @MPSAContributionEmail_DatFile_Positive_accounts_Validation @5504 @EMAIL @RS21098 @AUTOTESTTOTAL#21
  Scenario Outline: MPSA ContributionEmail_RS21098_5468_EMAIL Validate batch file details against database and pega for Positive test cases for Accounts
    Given load data from "MPSAContributionFunds" excel sheet
    Given read batch file customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    When read account information details from excel sheet "ACCT_DIM" for "<Test cases>"
    And read MPSA Contribution Funds "MPSAContributionFunds" extract file customer offer details
  ...
  @MPSAContributionEmail @MPSAContributionEmail_DatFile_Positive_Creatives_Validation_5504 @5504 @EMAIL @RS21098 @AUTOTESTTOTAL#15
  Scenario Outline: MPSA ContributionEmail_RS21098_5468_EMAIL Validate batch file details against database and pega for Positive test cases for Creatives
    Given load data from "MPSAContributionFunds" excel sheet
    Given read batch file customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    When read account information details from excel sheet "ACCT_DIM" for "<Test cases>"
    And read MPSA Contribution Funds "MPSAContributionFunds" extract file customer offer details
  ...
  @MPSAContributionEmail @MPSAContributionEmail_DatFile_Positive_Validation_negcreative_5504 @5504 @EMAIL @RS21098 @AUTOTESTTOTAL#19
  Scenario Outline: MPSA ContributionEmail_RS21098_5468_EMAIL Validate batch file details against database and pega for negative eligibility for creatives
    Given load data from "MPSAContributionFunds" excel sheet
    Given read batch file customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    When read account information details from excel sheet "ACCT_DIM" for "<Test cases>"
    And read MPSA Contribution Funds "MPSAContributionFunds" extract file customer offer details
  ...
  @MPSAContributionEmail @MPSAContributionEMail_DatFile_Negative_Validation_5504  @5504 @EMAIL @RS21098  @AUTOTESTTOTAL#72
  Scenario Outline: MPSA Contribution Email_RS21098_5504_EMAIL Validate batch file details against database and pega for Negative test cases
    Given load data from "MPSAContributionFunds" excel sheet
    Given read batch file customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    When read account information details from excel sheet "ACCT_DIM" for "<Test cases>"
    And read MPSA Contribution Funds "MPSAContributionFunds" extract file customer offer details
