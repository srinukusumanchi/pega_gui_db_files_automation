Feature: Batch file validation for D2D Engagement Welcome BBA
...
#  Example: “AcctNum:” + .ACCT_NUM + “|LastName:”+”.INDV_LAST_NM+”|AcctBal:”+.ACCT_BAL_AMT
  ...
  @D2DEngagementWelcome @D2DEngagementWelcomeBBA_DatFile_Positive_Validation @Workstream-4 @4330 @EMAIL @RS17103
  Scenario Outline: D2D Engagement Welcome_RS17103_4330_EMAIL Validate batch file details against database and pega for Positive test cases
...
### Batch File Validations are not required for Negative Scenarios
#
#  @D2DEngagementWelcome @D2DEngagementWelcomeBBA_DatFile_Negative_Validation @Workstream-4 @4330 @EMAIL @RS17103
#  Scenario Outline: D2D Engagement Welcome_RS17103_4330_EMAIL Validate batch file details against database and pega for Negative test cases
#    Given load data from "Welcome" excel sheet
#    Given read batch file customer information details from excel sheet "CUST_DIM" for "<Test cases>"
#    When read account information details from excel sheet "ACCT_DIM" for "<Test cases>"
#    When read purl cust information details from excel sheet "PURL_CUST_PROFILE" for "<Test cases>"
