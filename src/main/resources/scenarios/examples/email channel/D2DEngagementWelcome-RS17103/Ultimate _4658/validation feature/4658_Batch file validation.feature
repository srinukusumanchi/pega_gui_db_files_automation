Feature: Batch file validation for D2D Engagement Welcome Ultimate
...
#  Example: “AcctNum:” + .ACCT_NUM + “|LastName:”+”.INDV_LAST_NM+”|AcctBal:”+.ACCT_BAL_AMT
  ...
  @D2DEngagementWelcome @D2DEngagementWelcomeUltimate_DatFile_Positive_Validation @Workstream-4 @4658 @EMAIL @RS17103
  Scenario Outline: D2D Engagement Welcome_RS17103_4658_EMAIL Validate batch file details against database and pega for Positive test cases
...
# Added for Feb 18 Rls 2023
      | 4658_HAS_CLOSED_CHQ_F !=Y   |
      | 4658_HAS_CLOSED_CHQ_F =Y    |
      | 4658_HAS_CLOSED_CHQ_F =NULL |

  @D2DEngagementWelcome @D2DEngagementWelcomeUltimate_DatFile_Negative_Validation @Workstream-4 @4658 @EMAIL @RS17103
  Scenario Outline: D2D Engagement Welcome_RS17103_4658_EMAIL Validate batch file details against database and pega for Negative test cases
    Given load data from "Welcome" excel sheet
    Given read batch file customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    When read account information details from excel sheet "ACCT_DIM" for "<Test cases>"
    When read purl cust information details from excel sheet "PURL_CUST_PROFILE" for "<Test cases>"
