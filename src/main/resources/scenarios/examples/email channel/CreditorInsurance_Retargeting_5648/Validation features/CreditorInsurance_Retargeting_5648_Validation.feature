Feature: Validation for Creditor Insurance Retargeting 5648 Email

  @EMAIL  @CIReTargetingOfferEmail @5648 @CIRetargeting_5648_IHValidation_POSITIVE @VS17084 @AUTOTESTTOTAL#56
  ...
  @EMAIL  @CIReTargetingOfferEmail @5648 @CIRetargeting_5648_IHValidation_NEGATIVE @VS17084 @AUTOTESTTOTAL#45
  Scenario Outline: Creditor Insurance Retargeting_VS17084_EMAIL Validate offer details are not displayed against IH for Negative test cases
    Given load data from "CredInsReTargeting5648Email" excel sheet
    Given read customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    And read account information details from excel sheet "ACCT_DIM" for "<Test cases>"
    And read customer and account information details from excel sheet "CUST_ACCT_RLTNP_DIM" for "<Test cases>"
