@ODPRightSizing_IH_Validation
Feature: Validation of IH for ODP Right Sizing for all channels

  @EMAIL @ODPRIGHTSIZING @5614 @ODPRIGHTSIZING_5614_IH_POSITIVE @RS21131 @AUTOTESTTOTAL#64
  Scenario Outline: ODP Right Sizing Email channel Validate offer details against IH for Positive test cases
  ...
  @EMAIL @ODPRIGHTSIZING @5614 @ODPRIGHTSIZING_5614_IH_NEGATIVE @RS21131 @AUTOTESTTOTAL#26
  Scenario Outline: ODP Right Sizing Email channel Validate offer details against IH for Negative test cases
    Given load data from "ODPRightSizing" excel sheet
    Given read batch file customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    When read account information details from excel sheet "ACCT_DIM" for "<Test cases>"
    And read ODP Right Sizing "ODPRightSize" extract file with Preference customer offer details
