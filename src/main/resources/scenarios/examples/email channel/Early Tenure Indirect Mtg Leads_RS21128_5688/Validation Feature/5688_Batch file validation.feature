@5688_Batch_Validation
Feature: Batch file validation for Early Tenure Indirect Mortgage Leads RS21128


  @EarlyTenureIndirectMtgLeadsEmail @EarlyTenureIndirectMtgLeadsEmail_DatFile_Positive_Generic_Validation @5688 @EMAIL @RS21128 @AUTOTESTTOTAL#31
  Scenario Outline: IndirectMortgageLeads Email_RS21128_5688_EMAIL Validate batch file details against database and pega for Positive test cases
  ...
  @EarlyTenureIndirectMtgLeadsEmail @EarlyTenureIndirectMtgLeadsEmail_DatFile_Negative_Validation_5688 @5688 @EMAIL @RS21128  @AUTOTESTTOTAL#46
  Scenario Outline: EarlyTenureIndirectMtgLeads Email_RS21128_5688_EMAIL Validate batch file details against database and pega for Negative test cases
    Given load data from "EarlyTenureIndirectMtgLeadsEmail" excel sheet
    Given read batch file customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    When read account information details from excel sheet "ACCT_DIM" for "<Test cases>"
    And read Early Tenure Indirect Mtg Leads "IndirectMtgEmail" extract file customer offer details
