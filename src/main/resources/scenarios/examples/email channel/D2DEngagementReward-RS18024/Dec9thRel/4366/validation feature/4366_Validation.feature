...
#  It also include a test of the target population who are NEW TO BANK based on Customer relationship date within the last 7 days
  @D2DEngagementReward @D2DEngagementReward_Positive_Validation_NoReward_4366 @Workstream-4 @4366 @EMAIL @RS18024
...
#      | 4366_Account Open Date equal to 32 days                 |
#      | 4366_Account Open Date equal to 35 days                 |
#      | 4366_Account Open Date equal to 33 days(>32 and <35)    |
...
#      | 4366_NTC_ARRV_DT_eq_5years                                |
      | 4366_NTC_ARRV_DT_gt_5years                                |
#      | 4366_NTC_ARRV_DT_eq_NULL                                |

  @D2DEngagementReward @D2DEngagementReward-NoReward_Negative_Validation_4366 @Workstream-4 @4366 @EMAIL @RS18024
...
#    And enter customer id in ih by customer screen and get IH table data
    ...
    Examples:
      ...
      | N_4366_Account Open Date greater than 35 days             |
      | N_4366_Account Open Date equal to Null                    |
      | N_4366_Account Open Date less than 32                     |
      | N_4366_Deceased_F=Y                                       |
