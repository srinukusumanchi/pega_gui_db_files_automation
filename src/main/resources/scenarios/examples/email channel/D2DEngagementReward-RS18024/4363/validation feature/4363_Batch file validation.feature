Feature: Batch file validation for D2D Engagement Reward TRAVEL
...
#  Example: “AcctNum:” + .ACCT_NUM + “|LastName:”+”.INDV_LAST_NM+”|AcctBal:”+.ACCT_BAL_AMT
  ...
  @D2DEngagementReward @D2DEngagementReward_DatFile_Positive_Validation_Travel @Workstream-4 @4363 @EMAIL @RS18024
  Scenario Outline: D2D Engagement Reward_RS18024_4363_EMAIL Validate batch file details against database and pega for Positive test cases
  ...
  @D2DEngagementReward @D2DEngagementReward_DatFile_Negative_Validation_Travel @Workstream-4 @4363 @EMAIL @RS18024
  Scenario Outline: D2D Engagement Reward_RS18024_4363_EMAIL Validate batch file details against database and pega for Negative test cases
    Given load data from "Reward" excel sheet
    Given read batch file customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    When read account information details from excel sheet "ACCT_DIM" for "<Test cases>"
    When read purl cust information details from excel sheet "PURL_CUST_PROFILE" for "<Test cases>"
