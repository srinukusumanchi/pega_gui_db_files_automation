Feature: Validation for 5465 RRSPCrossSell

  @RRSPCrossSellEmail @RRSPCrossSell_Positive_Validation @Workstream-4 @5465 @EMAIL @RS21093  @AUTOTESTTOTAL#47
  Scenario Outline: RRSPCrossSell_RS21093_5465_EMAIL Validate offer details against IH for Positive test cases
...
#    And enter customer id in ih by customer screen and get IH table data
    ...
    Examples:
      ...
      | 5465_EML_VALID_START_DATE_lt_Curr_Dt                                                                                                                                                                                                                   |
      | 5465_EML_VALID_START_DATE_eq_Curr_Dt                                                                                                                                                                                                                   |
      | 5465_EML_VALID_END_DATE_gt_Curr_Dt                                                                                                                                                                                                                     |
      | 5465_EML_VALID_END_DATE_eq_Curr_Dt                                                                                                                                                                                                                     |

    #Multiple Accounts,External Records

      | 5465_EML_Multiple_Externaltbl_Records                                                                                                                                                                                                                  |
    # Added for july 06th 2023 REL
      | 5465_EML_Trigger4                                                                                                                                                                                                                                      |
      | 5465_EML_Trigger4_EV_RT_RRSP_XSELL _eq_DSS_Name_RRSP_Xsell_RS21093_EV_Threshold                                                                                                                                                                        |

  @RRSPCrossSellEmail @RRSPCrossSellEmail_Negative_Validation @Workstream-4 @5465 @EMAIL @RS21093  @AUTOTESTTOTAL#36
  Scenario Outline: RRSP CrossSell Email_RS21093_5465_EMAIL Validate offer details against IH for Negative test cases
    Given load data from "RRSPCrossSell" excel sheet
    Given read customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    And read account information details from excel sheet "ACCT_DIM" for "<Test cases>"
#    And read customer and account information details from excel sheet "CUST_ACCT_RLTNP_DIM" for "<Test cases>"
...
#    And enter customer id in ih by customer screen and get IH table data
    ...
    Examples:
      ...
      | N_5465_EML_VALID_START_DATE_gt_Curr_Dt                                                   |
      | N_5465_EML_VALID_END_DATE_lt_Curr_Dt                                                     |
      | N_5465_EML_CAMPAIGN_CODE_ne_RS21093                                                      |
      | N_5465_EML_CAMPAIGN_CELL_CODE_ne_CIE5465                                                 |
      | N_5465_EML_CAMPAIGN_CELL_CODE_eq_NULL                                                    |
      | N_5465_EML_CAMPAIGN_CELL_CODE_FLAG_ne_Y                                                  |
      | N_5465_EML_CAMPAIGN_CELL_CODE_FLAG_eq_NULL                                               |
      | N_5465_EML_EMAIL_CHANNEL_ne_Y                                                            |
      | N_5465_EML_EMAIL_CHANNEL_eq_NULL                                                         |

## Added for july 06th 2023 REL

      | N_5465_EML_Trigger4_EV_RT_RRSP_XSELL _lt_DSS_RRSP_Xsell_RS21093_EV_Threshold             |
      | N_5465_EML_Trigger4_EV_RT_RRSP_XSELL_eq_NULL                                             |
