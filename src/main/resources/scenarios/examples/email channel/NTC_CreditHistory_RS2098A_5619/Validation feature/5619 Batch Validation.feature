@NTCCreditHistory_BATCH_VALIDATION
Feature: Validation of Batch file NTC Credit History scenarios

  ##########################EMAIL#############################

  @EMAIL @NTCCreditHistory @5619 @NTCCreditHistory_5619_BATCH_POSITIVE @RS2098A @AUTOTESTTOTAL#30
  Scenario Outline: NTC Credit History Email channel Validate batch file details against database and pega for Positive test cases
    ...
    Examples:
      ...
      | 5619_EMAIL_LANG_CD=en_LoweCase                          |
      | 5619_EMAIL_DO_NOT_SOLICIT_F=NULL                        |
      | 5619_EMAIL_MCB_IND = Y                                  |
      | 5619_EMAIL_ARR_DT LT 3 years                            |
      | 5619_EMAIL_13_01                                        |
      | 5619_EMAIL_13_03                                        |
      | 5619_EMAIL_13_07                                        |
      | 5619_EMAIL_13_08                                        |
  ...
  @EMAIL @NTCCreditHistory @5619 @NTCCreditHistory_5619_BATCH_NEGATIVE @RS2098A @AUTOTESTTOTAL#52
  Scenario Outline: NTC Credit History Email channel Validate batch file details against database and pega for Negative test cases
    Given load data from "NTCCreditHistory" excel sheet
    Given read batch file customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    When read account information details from excel sheet "ACCT_DIM" for "<Test cases>"
    And read NTC Credit History "NTCCreditHist" extract file with Preference customer offer details
...
#      | N-5619_EMAIL_ARR_DT GT 3 years                          |
