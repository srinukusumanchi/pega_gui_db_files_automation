Feature: Batch file validation for RESP_Cross Sell RS21095
...
#  Example: “AcctNum:” + .ACCT_NUM + “|LastName:”+”.INDV_LAST_NM+”|AcctBal:”+.ACCT_BAL_AMT
  ...
  @RESPCrossSellEmail @RESPCrossSellEmail_DatFile_Positive_Validation_5466 @5466 @EMAIL @RS21095  @AUTOTESTTOTAL#47
  Scenario Outline: RESP CrossSellEmail_RS21091_5466_EMAIL Validate batch file details against database and pega for Positive test cases
  ...
  @RESPCrossSellEmail @RESPCrossSellEMail_DatFile_Negative_Validation_5466 @Workstream-4 @5466 @EMAIL @RS21095  @AUTOTESTTOTAL#33
  Scenario Outline: RESP Cross Sell Email_RS21095_5466_EMAIL Validate batch file details against database and pega for Negative test cases
    Given load data from "RESPCrossSell" excel sheet
    Given read batch file customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    When read account information details from excel sheet "ACCT_DIM" for "<Test cases>"
    And read RESP CrossSell "RESP" extract file customer offer details
