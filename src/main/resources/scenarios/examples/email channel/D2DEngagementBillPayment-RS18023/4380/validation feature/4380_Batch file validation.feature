Feature: Batch file validation for D2D Engagement Bill Payment
...
#  Example: “AcctNum:” + .ACCT_NUM + “|LastName:”+”.INDV_LAST_NM+”|AcctBal:”+.ACCT_BAL_AMT
  ...
  @D2DEngagementEngagementBillPayment @D2DEngagementBillPayment_DatFile_Positive_Validation_Unknown @Workstream-4 @4380 @EMAIL @RS18023
  Scenario Outline: D2D Engagement BillPayment_RS18023_4380_EMAIL Validate batch file details against database and pega for Positive test cases
...
#    Then validate D2D offer details in batch file against database and pega
  ...
  # Added for Feb 18 Rls 2023
      | 4380_HAS_CLOSED_CHQ_F !=Y      |
      | 4380_HAS_CLOSED_CHQ_F =Y       |
      | 4380_HAS_CLOSED_CHQ_F =NULL    |

  @D2DEngagementEngagementPADPayment @D2DEngagementPADPayment_DatFile_Negative_Validation_Unknown @Workstream-4 @4380 @EMAIL @RS18023
  Scenario Outline: D2D Engagement PADPayment_RS18023_4380_EMAIL Validate batch file details against database and pega for Negative test cases
    Given load data from "BillPayment" excel sheet
    Given read batch file customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    When read account information details from excel sheet "ACCT_DIM" for "<Test cases>"
    When read purl cust information details from excel sheet "PURL_CUST_PROFILE" for "<Test cases>"
