Feature: Batch file validation for GIC-1210
...
#  Example: “AcctNum:” + .ACCT_NUM + “|LastName:”+”.INDV_LAST_NM+”|AcctBal:”+.ACCT_BAL_AMT
  ...
  @GICRenewalEmail @GICRenewalEmail_BatchFile_Positive_Validation_1210 @1210 @Email @ET14061
  Scenario Outline: GIC_VS16008_1210_EMAIL Validate batch file details against database and pega for Positive test cases
    ...
    Examples:
      ...
      | 1210_N_INDV_TTL_NM=NULL                                                                                                                                          |
      | 1210_N_INDV_TTL_NM=BLANK                                                                                                                                         |


  @GICRenewalEmail @GICRenewalEmail_BatchFile_Negative_Validation_1210 @1210 @Email @ET14061
  Scenario Outline: GIC_VS16008_1210_EMAIL Validate batch file details against database and pega for Negative test cases
    Given load data from "GIC_EML" excel sheet
    Given read batch file customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    When read account information details from excel sheet "ACCT_DIM" for "<Test cases>"
    And the user navigates to pega url
