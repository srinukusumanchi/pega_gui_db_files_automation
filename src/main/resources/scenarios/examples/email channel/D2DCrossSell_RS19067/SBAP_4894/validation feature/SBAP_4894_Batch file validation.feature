...
#  Example: “AcctNum:” + .ACCT_NUM + “|LastName:”+”.INDV_LAST_NM+”|AcctBal:”+.ACCT_BAL_AMT
  ...
  @CrossSell @CrossSell_BatchFile_Positive_Validation @Workstream-4 @4894 @EMAIL @RS19067
  Scenario Outline: Cross sell SBAP 4894_RS19067_EMAIL Validate batch file details against database and pega for Positive test cases
  ...
  @CrossSell @CrossSell_BatchFile_Negative_Validation @4894 @Workstream-4 @EMAIL @RS19067
  Scenario Outline: Cross sell SBAP 4894_RS19067_EMAIL Validate batch file details against database and pega for Negative test cases
    Given load data from "D2DCrossSell" excel sheet
    Given read batch file customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    When read account information details from excel sheet "ACCT_DIM" for "<Test cases>"
    And read D2D "BatchD2D" extract file customer offer details
