@EMOB_Notification_EML_5894_Batch_File_Validation
Feature: Validation for 5894 EMOB Notification in EML Channel Batch File Validation


  @EMOB_Notification @EMOB_Notification_EML_Batch_File_Base_Validation_5894 @5894 @EML @VS16008
  Scenario Outline: EMOB_Notification VS16008_5894_EML Validate Batch File against database and pega for Base Line test cases
  ...
  @EMOB_Notification @EMOB_Notification_EML_Batch_File_Positive_Validation_5894 @5894 @EML @VS16008
  Scenario Outline: EMOB_Notification VS16008_5894_EML Validate Batch File against database and pega for Positive Line test cases
    Given load data from "EMOB_Notification_5894" excel sheet
    Given read batch file customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    When read account information details from excel sheet "ACCT_DIM" for "<Test cases>"
    And read "EMOBNotification_EML_Batch" extract EMOB file with batch "ProvCode;ProductCode;SubProductCode;" Email Specific Text Header
