@EarlyTenureIndirectMtgLeads_PosNeg_5688_SB_TestDataLoad
Feature: Test data creation for SB EarlyTenureIndirectMtgLeads


  @EarlyTenureIndirectMtgLeads_SB_111 @EarlyTenureIndirectMtgLeads_SB_Positive_TestData_5688_111 @5688 @EarlyTenureIndirectMtgLeadsSB @RS21128 @111
  Scenario Outline: EarlyTenureIndirectMtgLeads_RS21128_5688_SB Create test data for 111
    Given load data from "EarlyTenureIndirectMtgLeadsSB" excel sheet
...
#      | 5688_MAPP_TMRRW_LAST_SESS_DT = NULL                                                                                                                          | 37            |
#      | 5688_DO_NOT_CALL_F=N                                                                                                                                         | 33            |
#      | 5688_VLD_PH_F = Y                                                                                                                                            | 35            |
#      | 5688_ACCT_SUBSYS_ID = UO And SRC_ACCT_STAT_CD = Active And IP_AR_RELATN_TYPE_CD = SOL And MORT_COMM_TYPE = Residential And ACCT_SOURCE_ORIG_CHANNEL = BROKER | 58            |
...
#      | 5688_ACCT_SUBSYS_ID = UO And SRC_ACCT_STAT_CD = Active And IP_AR_RELATN_TYPE_CD = COB And MORT_COMM_TYPE = Residential And ACCT_SOURCE_ORIG_CHANNEL = BROKER | 32            |
      | 5688_CURRENT DATE - MORT_FNDNG_DT<=90 and >=30 | 31            |
      | 5688_CURRENT DATE - MORT_FNDNG_DT = 90         | 90            |
      | 5688_CURRENT DATE - MORT_FNDNG_DT = 30         | 30            |
#      | 5688_GIVEN_NAME != NULL And Title_FirstName_Last Name = NULL                                                                                                 | 35            |
#      | 5688_GIVEN_NAME_Title_Last Name = NULL And FirstName!= NULL                                                                                                  | 35            |
#      | 5688_GIVEN_NAME_Title_FirstName = NULL And Last Name != NULL                                                                                                 | 35            |
#      | 5688_GIVEN_NAME_FirstName_Last Name = NULL And Title!= NULL                                                                                                  | 35            |
      | 5688_MORTGAGE_OWNERSHIP_BRANCH_TRANSIT_NUM != NULL                                                                                                           | 35            |
#      | 5688_URL for opportunity pop-up_FirstName = NULL                                                                                                             | 35            |
#      | 5688_URL for opportunity pop-up_LastName = NULL                                                                                                              | 35            |
#      | 5688_URL for opportunity pop-up_MORT_APPRV_DT = NULL                                                                                                         | 35            |
#      | 5688_URL for opportunity pop-up_CUST_OPND_DT = NULL                                                                                                          | 35            |

  @EarlyTenureIndirectMtgLeads_SB_1111 @EarlyTenureIndirectMtgLeads_SB_Positive_TestData_5688_1111 @5688 @EarlyTenureIndirectMtgLeadsSB @RS21128 @1111
  Scenario Outline: EarlyTenureIndirectMtgLeads_RS21128_5688_SB Create test data for 1111
    Given load data from "EarlyTenureIndirectMtgLeadsSB" excel sheet
    Given write cid into "CUST_DIM" sheet for "<Test cases>"
    When read customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    Then insert customer information details in "CUST_DIM" table
  ...
  @EarlyTenureIndirectMtgLeads_SB_111 @EarlyTenureIndirectMtgLeads_SB_Negative_TestData_5688_111 @5688 @EarlyTenureIndirectMtgLeadsSB @RS21128 @111
  Scenario Outline: EarlyTenureIndirectMtgLeads_RS21128_5688_SB Create Negative test data for 111
    Given load data from "EarlyTenureIndirectMtgLeadsSB" excel sheet
    Given write cid into "CUST_DIM" sheet for "<Test cases>"
    When read customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    Then insert customer information details in "CUST_DIM" table
...
#      | N-5688_ACCT_SOURCE_ORIG_CHANNEL = NULL              | 35            |
      ...
      | N-5688_CURRENT DATE - MORT_FNDNG_DT > 91   | 92            |
...
#      | N-5688_DO_NOT_CALL_F=Y                              | 35            |
#      | N-5688_DO_NOT_CALL_F=NULL                           | 35            |
#      | N-5688_VLD_PH_F = N                                 | 35            |
#      | N-5688_VLD_PH_F = NULL                              | 35            |
#      | N-5688_GIVEN_NAME_Title_FirstName_Last Name = NULL  | 35            |
      | N-5688_MORTGAGE_OWNERSHIP_BRANCH_TRANSIT_NUM = NULL | 35            |
      | N-5688_MORTGAGE_OWNERSHIP_BRANCH_TRANSIT_NUM =80002 | 35            |


  @EarlyTenureIndirectMtgLeads_SB_144 @EarlyTenureIndirectMtgLeadsSB_Negative_TestData_5688_144 @5688 @EarlyTenureIndirectMtgLeadsSB @RS21128 @144
  Scenario Outline: EarlyTenureIndirectMtgLeads_RS21128_5688_SB Create Negative test data for 144
    Given load data from "EarlyTenureIndirectMtgLeadsSB" excel sheet
    Given write cid into "CUST_DIM" sheet for "<Test cases>"
    When read customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    Then insert customer information details in "CUST_DIM" table
  ...
  @EarlyTenureIndirectMtgLeads_SB_155 @EarlyTenureIndirectMtgLeadsSB_Negative_TestData_5688_155 @5688 @EarlyTenureIndirectMtgLeadsSB @RS21128 @155
  Scenario Outline: EarlyTenureIndirectMtgLeads_RS21128_5688_SB Create Negative test data for 155
    Given load data from "EarlyTenureIndirectMtgLeadsSB" excel sheet
    Given write cid into "CUST_DIM" sheet for "<Test cases>"
    When read customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    Then insert customer information details in "CUST_DIM" table
  ...
  @EarlyTenureIndirectMtgLeads_SB_133 @EarlyTenureIndirectMtgLeadsSB_Negative_TestData_5688_133 @5688 @EarlyTenureIndirectMtgLeadsSB @RS21128 @133
  Scenario Outline: EarlyTenureIndirectMtgLeads_RS21128_5688_SB Create Negative test data for 133
    Given load data from "EarlyTenureIndirectMtgLeadsSB" excel sheet
    Given write cid into "CUST_DIM" sheet for "<Test cases>"
    When read customer information details from excel sheet "CUST_DIM" for "<Test cases>"
    Then insert customer information details in "CUST_DIM" table
    ...
    Examples:
      ...
      | 5688_Multiple Eligible UO Accounts_Priority_Max_MORT_FNDNG_DT     | 35            |
